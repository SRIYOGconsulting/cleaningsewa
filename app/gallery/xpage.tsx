...
function Gallery() {
    ...
    const galleryItems = [
        { id: 1, image: '/images/gallery/1.jpg', title: 'Digital Solutions Launch', date: 'Jun 14, 2018', place: 'Kathmandu Durbar Square', count: 10, description: 'Marking the beginning of Cleaning Sewa ., empowering organizations with innovative IT solutions.' },
