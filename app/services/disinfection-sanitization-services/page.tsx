      ...
      <div className="mx-auto px-5 py-10 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-5 flex flex-col items-center text-center">
            <img
              src="/services/disinfection-sanitization-services/1.jpg"
              alt="Specialized Disinfection"
              className="w-full h-48 object-cover rounded-lg mb-4"
            />
            <h3 className="text-xl font-semibold mb-2">Specialized Disinfection</h3>
          ...
          <div className="bg-white rounded-xl shadow-md p-5 flex flex-col items-center text-center">
            <img
              src="/services/disinfection-sanitization-services/2.jpg"
              alt="Carpet & Sofa Cleaning"
              className="w-full h-48 object-cover rounded-lg mb-4"
            />
            <h3 className="text-xl font-semibold mb-2">Healthcare Facility Sanitization</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-xl shadow-md p-5 flex flex-col items-center text-center">
            <img
              src="/services/disinfection-sanitization-services/3.jpg"
              alt="Post-Construction Cleaning"
              className="w-full h-48 object-cover rounded-lg mb-4"
            />
            <h3 className="text-xl font-semibold mb-2">Restroom Disinfection</h3>
            <p className="text-gray-600">
